...
public class FileProcessorTest {
    ...
    public void testProcessesValidFileAndReturnsIntermediateResults() {
        try {
            ...
            Files.write(testFile.toPath(), Arrays.asList("fname,lname,age", "Bar,Foo,12", "Baz,qux,13"));

            FileProcessor processor = new FileProcessor();
            List<IntermediateResult<?>> intermediateResults = processor.processFile(testFile, new TrivialResultOnly().resultsForShard());
